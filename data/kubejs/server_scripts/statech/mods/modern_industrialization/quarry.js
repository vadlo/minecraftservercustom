...
ServerEvents.recipes(e => {
    ...
    quarry(
        ...
        [
            ...
            { amount: 1, item: mc('copper_ore'), probability: 0.01 },
            { amount: 1, item: mi('tin_ore'), probability: 0.01 },
            { amount: 1, item: mc('gold_ore'), probability: 0.03 },
            { amount: 1, item: mi('lead_ore'), probability: 0.01 },
            { amount: 1, item: mc('redstone_ore'), probability: 0.04 },
            { amount: 1, item: tr('silver_ore'), probability: 0.03 },
            { amount: 1, item: tr('galena_ore'), probability: 0.01 },
            { amount: 1, item: mc('diamond_ore'), probability: 0.06 },
            { amount: 1, item: mc('lapis_ore'), probability: 0.07 }
        ]
    );

    e.remove({id: 'modern_industrialization:quarry/titanium'});
    quarry(
        st('titanium'),
        512,
        600,
        [ { amount: 1, item: mi('titanium_drill'), probability: 0.15 } ],
        [
            { amount: 1, item: mi('iridium_ore'), probability: 0.01 },
            { amount: 1, item: mi('tungsten_ore'), probability: 0.1 },
            { amount: 1, item: mi('mozanite_ore'), probability: 0.1 },
            { amount: 1, item: tr('sheldonite_ore'), probability: 0.07 },
            { amount: 1, item: tr('peridot_ore'), probability: 0.07 },
            { amount: 1, item: 'majruszsdifficulty:enderium_shard_ore', probability: 0.005 },
            { amount: 1, item: tr('sapphire_ore'), probability: 0.06 },
            { amount: 1, item: mi('antimony_ore'), probability: 0.05 },
            { amount: 1, item: mi('fluorite_ore'), probability: 0.05 },
            { amount: 1, item: mi('nickel_ore'), probability: 0.04 },
            { amount: 1, item: mi('bauxite_ore'), probability: 0.02 },
            { amount: 1, item: tr('ruby_ore'), probability: 0.05 },
            { amount: 1, item: tr('sapphire_ore'), probability: 0.07 },
            { amount: 1, item: mc('iron_ore'), probability: 0.06 },
            { amount: 1, item: mc('coal_ore'), probability: 0.01 },
            { amount: 1, item: mi('uranium_ore'), probability: 0.03 }
        ]
    );
    ...
    quarry(
        ...
        512,
        600,
        [ { amount: 1, item: mi('desh_drill'), probability: 0.08 } ],
        [
            { amount: 1, item: ad('moon_cheese_ore'), probability: 0.04 },
            { amount: 1, item: ad('moon_desh_ore'), probability: 0.04 },
            { amount: 1, item: ad('moon_ice_shard_ore'), probability: 0.04 },
            { amount: 1, item: ad('mars_ostrum_ore'), probability: 0.04 },
            { amount: 1, item: ad('mars_ice_shard_ore'), probability: 0.04 },
            { amount: 1, item: 'majruszsdifficulty:enderium_shard_ore', probability: 0.03 },
            { amount: 1, item: mi('deepslate_uranium_ore'), probability: 0.16 },
        ]
    );
});