...
ServerEvents.recipes(e => {
    ...
    // -- IMPURE LIQUID NETHER STAR -> MOLTEN NETHER STAR -- //
    blastFurnace(
    ...
    // -- ALUMINUM EBF -- //
    blastFurnace(
        st('aluminum_ingot_v1'),
        32,
        2400,
        [ { amount: 1, item: tr('aluminum_dust') } ],
        [ { amount: 1, item: mi('aluminum_ingot') } ]
    );

    // -- ALUMINUM EBF v2 -- //
    blastFurnace(
        st('aluminum_ingot_v2'),
        32,
        2400,
    ...
    blastFurnace(
        ...
        2400,
        [
            { amount: 1, tag: 'c:iridium_dusts' }, 
            { amount: 2, item: mi('platinum_tiny_dust') }
        ],
        [ { amount: 2, item: mi('iridium_ingot') } ],
        [ { amount: 4000, fluid: mi('argon') } ]
    );
