...
ServerEvents.recipes(e => {
    ...
    e.custom({
        ...
        key: {
            W: { item: 'botania:manaweave_cloth' }
        },
        result: {
    ...
    e.custom({
        ...
        key: {
            A: { item: mc('amethyst_shard') },
            E: { item: mc('copper_block') },
            S: { item: mc('stick') },
            G: { item: mc('stick') }
        },
        result: {
            item: mwz('lightning_staff'),
            count: 1
        },
        required_advancement: [
            sp('midgame/build_advanced_pedestal_structure')
